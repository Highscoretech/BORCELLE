<script>
    ...
    let games = [
    {id:1, name : "Crash", icon: IoDice,  route: "crash", isAtive: false},
    {id:2, name : "Classic Dice", icon: IoDice,  route: "classic-dice", isAtive: false },
    {id:3, name : "Plinko", icon: IoDice,  route: "plinko", isAtive: false },
    {id:4, name : "Tower", icon: IoDice,  route: "tower", isAtive: false },
    {id:5, name : "HiLo", icon: IoDice,  route: "hilo", isAtive: false },
    {id:6, name : "Diamonds", icon: IoDice,  route: "diamonds", isAtive: false },
    {id:7, name : "Mines", icon: IoDice,  route: "mines", isAtive: false },
]
...
.original-content .icon, .IsActive-original-content .icon{
    font-size: 17px;
    padding: 0 10px;
    fill:rgba(153,164,176,.8);
}
.original-content .name, .IsActive-original-content .name{
    padding: 2px;
}
...
.orginal-game-routes-container .original-content:hover, .original-content:hover .icon{
    color: #f5f6f7;
    font-weight: 800;
    fill:#f5f6f7;
